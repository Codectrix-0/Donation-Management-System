...
## Features
Add Donation: Input donor details (Name and Amount).
...
## Core Concepts Used
This project utilizes several fundamental C programming concepts:
...
## Sample Output
The system displays a menu where you can choose to add a donor, see all donors, or get the total sum.
Example:
